subroutine spec_vert_grid(Lp,Mp,N,h,Zt_avg1,Tcline,theta_b,theta_s,Vtransform,Vstretching,z_r,z_w)
implicit none
        ...
        DO j=1,Mp
          ...
          DO k=1,N !standard er k=1, blir prob at z_w refer til k=0!!
            ...
            DO i=1,Lp  !antar zeta=0
              ...
              z_w(i,j,k+1)=z_w0+Zt_avg1(i,j)*(1.0+z_w0*hinv) !håper Zt_avg1 er samme som zeta... sjekke!!
        ...
        DO j=1,Mp
          ...
          DO k=1,N
            ...
            DO i=1,Lp
              ...
              z_w(i,j,k+1)=Zt_avg1(i,j)+(Zt_avg1(i,j)+hwater)*cff2_w
...
!               z_r(i,j,k)=hwater*cff2_r
      ...
      END IF
!      write(*,*) '#####################################'
!     write(*,*) 'h:', -h(1,50), 'zeta:', Zt_avg1(1,50)
!     write(*,*) 'z_r: ',z_r(1,50,:)
!     write(*,*) '#####################################'
!     write(*,*) 'z_w: ',z_w(1,50,:)
!      write(*,*) '#####################################'
