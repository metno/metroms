...
N = dimlen(nc, 's_rho')  !27jan2012: nils changed from N to s_rho
...
call getvar0d(nc, "Vtransform", Vtrans)
print *, "hc = ", hc
print *, "Vtransfom = ", Vtrans
...
! -------------------------
! Topography at rho points
! -------------------------
call getvar2d(nc, 'h', F2)
