...
!
! !REVISION HISTORY:
!  SVN:$Id: CICE.F90 143 2008-08-08 23:08:22Z eclare $
!
...
!
      ...
      type (ESMF_State) :: &
         ciceImportState, ciceExportState
...
! declare as integer dummy arguments
      ...
      if (errorCode /= ESMF_SUCCESS) stop 'CICE: Error creating CICE comp'

      call ESMF_GridCompSetServices(CICE_Comp, CICE_SetServices, errorCode)

      if (errorCode /= ESMF_SUCCESS) stop 'CICE: Error registering CICE methods'
#endif
      ...
      call ESMF_GridCompFinalize(CICE_Comp, ciceImportState, &
       ...
       if (errorCode /= ESMF_Success) stop 'CICE: Error in finalize method'
